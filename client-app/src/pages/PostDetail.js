...
const PostDetail = ({
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      await getPostTags(
        `?$filter=PostID eq ${match.params.id} &$expand=Tag&$select=Tag`
      );
      console.log(post);
    };
    fetchData().then(() => {
      ...
      {loading === true ? (
        ...
        <div className="h-screen max-h-[calc(100vh-136px)] bg-slate-100">
          ...
          <div className="art-stage px-[100px] py-6 h-full relative">
            <div className="flex justify-center items-center h-full">
              <div className="file-wrapper  h-full bg-slate-100 flex justify-center items-center">
                {post.attachmentType === 1 ? (
                  <video
                    autoPlay
                    controls
                    className="max-h-full shadow-lg z-50"
                    src={post.fileURL}
                    alt="art-content"
                  />
                ) : (
              ...
              <div className="absolute top-0 right-0 left-0 bottom-0 h-full w-full py-6 text-neutral-50 opacity-5 hover:text-black hover:opacity-100 transition-all duratin-500">
                <Link
                  ...
                  color="inherit"
                  underline="none"
                  className="transition-all duration-300 hover:text-pink-400 hidden justify-center items-center gap-1 left-[27px] relative px-4 lg:inline-flex"
                >
          ...
          <div className="flex items-center h-[72px] pl-8 pr-2 w-full xl:w-1/2 lg:w-4/5 mx-auto">
            ...
            <a
              href="#comment-input"
              className="hover:text-pink-400 duration-300 transition-all flex justify-center items-center gap-1 font-bold border-neutral-400 border-r px-4"
            >
              <ChatBubbleOutline />
              Comment
            </a>
          ...
          <div className="w-full px-8 xl:w-1/2 lg:w-4/5 mx-auto">
              ...
              <div className="flex grow items-between">
                <div className="flex flex-col grow gap-1">
                  ...
                  <div className="subheader">
                    ...
                    <Link href="#" className="font-bold" color="inherit">
                      Username
                    </Link>
                    <span
                      className="ml-4 cursor-pointer text-pink-400 gap-[1px] inline-flex text-xs font-bold justify-center items-end leading-[12px]"
                      onClick={() => {
                        alert("Follow");
                      }}
                    >
            ...
            <div className="tag-list flex gap-2 mb-4">
              <a href="#" alt="searchCat">
                <Chip label="Category 1" variant="outlined" clickable></Chip>
              </a>
              <a href="#" alt="searchCat">
                <Chip label="Category 1" variant="outlined" clickable></Chip>
              </a>
            ...
            {/* Comment section */}
            <div className="mt-8">
              <div className="font-bold uppercase mb-8">78 Comments</div>
                ...
                <div className="flex flex-col grow">
                  <div className="flex flex-col grow bg-pink-100 pt-2 px-[12px] pb-[16px]  border-pink-100 rounded-md">
                    ...
                    <div>
                      ...
                      quasi architecto beatae vita e dicta sunt explicabo. Nemo
                      enim ipsam voluptatem quia voluptas s it aspernatur aut
                      odit aut fugit, sed quia consequuntur magni dolo res eos
                      qui ratione voluptatem sequi nesciunt. Neque porro
                      quisquam es t, qui dolorem ipsum quia dolor sit amet,
                      consectetur, adipisc i velit, sed quia non numquam eius
                      modi tempora incidunt ut labore et dolore magnam aliquam
                      quaerat voluptatem. U
                    </div>
                  </div>
