            ...
            <div className="h-screen max-h-[calc(100vh-136px)]">
                ...
                <div className='art-stage px-[100px] py-6 h-full relative'>
                    <div className='flex justify-center items-center h-full '>
                        <div className="file-wrapper shadow-lg h-full">
                            <img className='max-h-full' src="https://images.unsplash.com/photo-1525097487452-6278ff080c31" alt='art-content' />
                        </div>
                        <div className='absolute top-0 right-0 left-0 bottom-0 h-full w-full py-6 text-neutral-50 opacity-5 hover:text-black hover:opacity-100 transition-all duratin-500'>
                            <Link href="/" color='inherit' underline='none' className='transition-all duration-300 hover:text-pink-400 inline-flex justify-center items-center gap-1 left-[27px] relative px-4 '>
                ...
                {/* Action bar */}
                <div className=' flex items-center w-full xl:w-1/2 lg:w-3/4 mx-auto'>
                    ...
                    <div className='flex justify-center items-center gap-1 font-bold border-neutral-400 ml-auto px-4'>
                ...
                {/* Post information */}
                <div className='w-full xl:w-1/2 lg:w-3/4 mx-auto'>
                    {/* Post statisctic */}
                    <div className='post-info flex justify-center items-center mt-4 gap-3 grow mb-8'>
                        ...
                        <div className='flex grow items-between pr-8'>
